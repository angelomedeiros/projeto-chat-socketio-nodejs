...
router.get('/edit/:id', editRules, isLoggedIn, require('./../../services/users/edit'))
router.get('/:id', isLoggedIn,                 require('./../../services/users/show'))
router.post('/', createRules, isLoggedIn,      require('./../../services/users/create'))
router.put('/:id', updateRules, isLoggedIn,    require('./../../services/users/update'))
router.patch('/:id', updateRules, isLoggedIn,  require('./../../services/users/update'))
router.delete('/:id', removeRules, isLoggedIn, require('./../../services/users/remove'))
